...
export const appCopy = {
  ko: {
    loadingTitle: "주일 점심 모임",
    loadingSubtitle: "실시간 정보를 불러오는 중입니다...",
    communityLabel: "교회 커뮤니티",
    appTitle: "주일 점심 모임",
    share: "공유",
    yourName: "내 이름",
    ...
    qr: "QR",
    createGroup: "모임 만들기",
    createGroupDisabled: "세션 설정 후 모임을 만들 수 있습니다.",
    language: "언어",
    ...
    createModal: {
      ...
      helper: "모임을 만들면 자동으로 해당 모임에 참여합니다. 기존에 참여 중인 모임이 있으면 새 모임으로 변경됩니다.",
      creating: "만드는 중...",
      submit: "모임 만들기"
    },
    groupList: {
      emptyTitle: "아직 모임이 없습니다",
      emptyDescription: "이번 주 첫 점심 모임을 시작해 보세요.",
      fallbackName: "점심 모임",
      myGroup: "내 모임",
      createdBy: "만든 사람",
      link: "링크",
  ...
  en: {
    loadingTitle: "Sunday Lunch Groups",
    loadingSubtitle: "Loading live updates...",
    communityLabel: "Church Community",
    appTitle: "Sunday Lunch Groups",
    share: "Share",
    yourName: "Your name",
    ...
    createGroupDisabled: "Set up the current session before creating a group.",
    language: "Language",
    ...
    groupList: {
      ...
      emptyDescription: "Start the first lunch group for this Sunday.",
